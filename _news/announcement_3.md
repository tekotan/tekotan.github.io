...
{% include figure.liquid
   path="/assets/img/grad1.jpg"
   alt="In line before commencement ceremony"
...
{% include figure.liquid
   path="/assets/img/grad2.jpg"
   alt="Me with friends waiting to walk"
   class="img-fluid rounded z-depth-1"
   loading="lazy"
%}
...
{% include figure.liquid
   path="/assets/img/grad3.jpg"
   alt="Post-walk selfie with the chair"
   class="img-fluid rounded z-depth-1"
   loading="lazy"
%}
